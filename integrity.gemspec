...
Gem::Specification.new do |s|
  ...
  s.files = ["README.markdown", "Rakefile", "VERSION.yml", "app.rb", "bin/integrity", "config/config.sample.ru", "config/config.sample.yml", "config/thin.sample.yml", "integrity.gemspec", "lib/integrity.rb", "lib/integrity/build.rb", "lib/integrity/core_ext/object.rb", "lib/integrity/core_ext/string.rb", "lib/integrity/helpers.rb", "lib/integrity/installer.rb", "lib/integrity/migrations.rb", "lib/integrity/notifier.rb", "lib/integrity/notifier/base.rb", "lib/integrity/project.rb", "lib/integrity/project_builder.rb", "lib/integrity/scm.rb", "lib/integrity/scm/git.rb", "lib/integrity/scm/git/uri.rb", "public/buttons.css", "public/reset.css", "public/spinner.gif", "vendor/rack-contrib", "vendor/sinatra", "vendor/sinatra-diddies", "views/_build_info.haml", "views/build.haml", "views/error.haml", "views/home.haml", "views/integrity.sass", "views/layout.haml", "views/new.haml", "views/not_found.haml", "views/notifier.haml", "views/project.builder", "views/project.haml", "views/unauthorized.haml", "vendor/sinatra/lib/sinatra", "vendor/sinatra/lib/sinatra/base.rb", "vendor/sinatra/lib/sinatra/compat.rb", "vendor/sinatra/lib/sinatra/images", "vendor/sinatra/lib/sinatra/images/404.png", "vendor/sinatra/lib/sinatra/images/500.png", "vendor/sinatra/lib/sinatra/main.rb", "vendor/sinatra/lib/sinatra/test", "vendor/sinatra/lib/sinatra/test/bacon.rb", "vendor/sinatra/lib/sinatra/test/rspec.rb", "vendor/sinatra/lib/sinatra/test/spec.rb", "vendor/sinatra/lib/sinatra/test/unit.rb", "vendor/sinatra/lib/sinatra/test.rb", "vendor/sinatra/lib/sinatra.rb", "vendor/sinatra-diddies/lib/diddies", "vendor/sinatra-diddies/lib/diddies/authorization.rb", "vendor/sinatra-diddies/lib/diddies/mailer.rb", "vendor/sinatra-diddies/lib/diddies.rb", "vendor/rack-contrib/lib/rack", "vendor/rack-contrib/lib/rack/contrib", "vendor/rack-contrib/lib/rack/contrib/bounce_favicon.rb", "vendor/rack-contrib/lib/rack/contrib/callbacks.rb", "vendor/rack-contrib/lib/rack/contrib/etag.rb", "vendor/rack-contrib/lib/rack/contrib/evil.rb", "vendor/rack-contrib/lib/rack/contrib/garbagecollector.rb", "vendor/rack-contrib/lib/rack/contrib/jsonp.rb", "vendor/rack-contrib/lib/rack/contrib/lighttpd_script_name_fix.rb", "vendor/rack-contrib/lib/rack/contrib/locale.rb", "vendor/rack-contrib/lib/rack/contrib/mailexceptions.rb", "vendor/rack-contrib/lib/rack/contrib/nested_params.rb", "vendor/rack-contrib/lib/rack/contrib/post_body_content_type_parser.rb", "vendor/rack-contrib/lib/rack/contrib/proctitle.rb", "vendor/rack-contrib/lib/rack/contrib/profiler.rb", "vendor/rack-contrib/lib/rack/contrib/sendfile.rb", "vendor/rack-contrib/lib/rack/contrib/time_zone.rb", "vendor/rack-contrib/lib/rack/contrib.rb"]
